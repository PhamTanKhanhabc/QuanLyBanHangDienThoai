...
public class Chart extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panelLegend.setPreferredSize(new java.awt.Dimension(0, 28));

        // Layout chính
        setLayout(new java.awt.BorderLayout(0, 0));

        // Padding giống containerGap()
        setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 10, 10, 10));

        // Chart
        blankPlotChart.setPreferredSize(new java.awt.Dimension(0, 342)); // gần giống layout cũ
