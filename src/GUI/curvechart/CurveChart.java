...
public class CurveChart extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panelLegend.setPreferredSize(new java.awt.Dimension(0, 28)); // cao 28px như cũ

        // Layout chính
        setLayout(new java.awt.BorderLayout(0, 0)); // gap ngang/dọc 0

        // Padding xung quanh giống addContainerGap()
        setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 10, 10, 10));

        // Chart: set preferred size để giống GroupLayout cũ
        blankPlotChart.setPreferredSize(new java.awt.Dimension(0, 342));

        // Thêm component vào layout
        add(blankPlotChart, java.awt.BorderLayout.CENTER);
        add(panelLegend, java.awt.BorderLayout.SOUTH);

        // Optional: repaint để chắc chắn layout được áp dụng
        revalidate();
        repaint();
    }                                      
}
